        ...
        <div class="item-cont h-100">
            <div class="item-style h-100">
                ...
                <div class="chat-cont">
                    ...
                    <a v-else v-for="chat in my_user_chats.user_chats" :href="'/admin/chats/' + chat.id" class="chat-item" v-cloak>
                        <span class="text-capitalize">@{{chat.name}} @{{chat.surname}}</span>
                    ...
                    <div v-for="page in my_pages_chats" class="" v-cloak>
                        <div v-show="page.page_chats!=''" class="">
                            ...
                            <a v-for="chat in page.page_chats" :href="'/admin/chats/' + chat.id" class="chat-item">
