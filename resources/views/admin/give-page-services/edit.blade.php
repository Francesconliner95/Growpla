    ...
    <div id="service-edit">
        <div class="item-cont">
            <div class="item-style">
                ...
                <form method="POST" action="{{ route('admin.give-page-services.update',$gps->id) }}">
                    @csrf
                    @method('PUT')
                ...
                <form method="post" action="{{ route('admin.give-page-services.destroy', $gps->id)}}" class="p-0 m-0 d-inline-block">
                @csrf
                @method('DELETE')
