    ...
    <div id="service-edit">
        <div class="item-cont">
            <div class="item-style">
                ...
                <form method="POST" action="{{ route('admin.have-page-services.update',$hps->id) }}">
                    @csrf
                    @method('PUT')
                ...
                <form method="post" action="{{ route('admin.have-page-services.destroy', $hps->id)}}" class="p-0 m-0 d-inline-block">
                @csrf
                @method('DELETE')
