            ...
            <div class="item-style">
                ...
                {{-- <form runat="server">
                    ...
                    <div class="cropper" id="copper-main">
                        <img :src="image_src" id="croppr"/>
                    </div>
                </form> --}}
                <form runat="server" class="file-cont" ref="editAccount" method="POST" enctype="multipart/form-data" action="{{ route('admin.accounts.updateImage', ['account_id'=> $account_id]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-2">
                        ...
                        <button v-if="image!='accounts_images/default_account_image.png'" type="button" name="button" class="button-style button-color-red" @click="remove_file('img')">{{__('Delete')}}</button>
                    </div>
                </form>
            </div>
        </div>
