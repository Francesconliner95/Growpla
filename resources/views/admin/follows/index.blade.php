...
<div  id="follows-index" style="background-image: url({{asset("storage/images/bg-follow.svg") }}); background-position: left -150px top 0px; background-repeat: no-repeat; background-attachment: fixed; background-size: 725px;">
    <div class="container">
        <div class="item-cont">
