                    ...
                    <div class="sub-section">
                        <h6>{{__('Competenze')}}
                            <div v-if="is_my_user" class="info" v-cloak>
                                <button type="button" class="tooltip-custom cursor-default" data-toggle="tooltip" data-placement="top" title="Inserisci competenze correlate a ciò che sai fare (SW utilizzati, linguaggi di programmazione, soft skill, aree di conoscenza e competenza e molto altro)">
