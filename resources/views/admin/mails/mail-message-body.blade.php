...
'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';">
    ...
    <main style="background-color:white; padding:50px; padding-top:30px; border-radius: 20px; margin-top:20px; margin-bottom:40px;">
        <h3 style="color: #3d4852; text-align: center;">Hai ricevuto un nuovo messaggio da {{$data['sender_name']}}</h3>
        <p style="color:gray; text-align:center;">{{$data['message']}}</p>
        <div style="text-align:center; padding:10px; margin:10px;">
            <a href="{{ route('admin.chats.show',$data['chat_id']) }}" style="background-color:#3490dc; border-radius:10px; border:none; color:white; padding: 10px 20px; text-decoration: none; font-weight:bold; margin:10px;">Rispondi</a>
        </div>
