              ...
              <div class="row d-flex justify-content-center ">
                  <div class="col-sm-12 col-md-11 col-lg-10 col-xl-10 custom-card p-5" style="background-color: rgba(255,255,255,.5)">
                    ...
                    <div class="">
                        ...
                        <p>{{__('These Terms and Conditions form a binding agreement between each user (the “User”) and Vincenzo Tarantino e Francesco Divincenzo (the “Owner”), Owner of the platform www.growpla.com .')}}</p>
                        <h6>{{__('GLOSSARY')}}</h6>
                        ...
                        <ul>
                            <p>a)	{{__('“Site / Platform / Growpla”: to mean the website www.growpla.com owned by Mr. Vincenzo Tarantino e Francesco Divincenzo')}}</p>
                            ...
                            <p>e)	{{__('“Vincenzo Tarantino e Francesco Divincenzo / Mr. Tarantino / The Owner”: to indicate Vincenzo Tarantino e Francesco Divincenzo.')}}</p>
                        </ul>
                        <h6>{{__('PREMISES')}}</h6>
                        <ul>
                            <p>a)	{{__('Vincenzo Tarantino e Francesco Divincenzo is the owner of the platform www.growpla.com;')}}</p>
                            <p>b)	{{__('Growpla possiede le informazioni e gli strumenti informatici e telematici utili ad agevolare il contatto tra tutti gli attori dell’ecosistema startup: startup, aspiranti Co-founder e studenti, incubatori-acceleratori di startup, Business Angel, prestatori di servizi alle startup (liberi professionisti, aziende e loro dipendenti), piattaforme di crowdfunding, enti ed associazioni. L’elenco sopraindicato è da intendersi in senso esemplificativo e non esaustivo;')}}</p>
                        ...
                        <p>{{__('La piattaforma comunicherà le informazioni necessarie affinché il servizio possa avvenire in maniera efficace e corretto come ad esempio i dati immessi dall’utente in fase di registrazione. L’utente potrebbe ricevere promemoria e/o delle notifiche allo scopo di essere aggiornato sui contatti avvenuti con altri utenti. La funzione del servizio offerto dalla piattaforma è quella di mettere in contatto tutti gli attori del mondo startup, a titolo esemplificativo: startup, aspiranti Co-founder e studenti, incubatori-acceleratori di startup, Business Angel, prestatori di servizi alle startup (liberi professionisti, aziende e loro dipendenti, piattaforme di crowdfunding, enti ed associazioni.')}}
                        ...
                        <h6>9.	{{__('CHANGES')}}</h6>
                        <p>{{__('Vincenzo Tarantino e Francesco Divincenzo reserves the right to update or modify these Terms and Conditions at any time. Mr. Tarantino will inform Users of any changes directly on the Site.')}}</p>
