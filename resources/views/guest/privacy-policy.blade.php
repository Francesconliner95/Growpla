...
@section('content')
    <div id="privacy-policy" class="container not-log-main-hg">
        <div class="item-cont">
            <div class="item-style">
                <h3 class="text-center mb-4">
                    ...
                    <span class="text-nowrap text-uppercase">{{__('Privacy policy')}}</span>
                </h3>
                <div class="">
                    <h5>{{__('Pursuant art. 13 of EU Regulation 679/2016')}}</h5>
